...
         * obstacles or move the robot and/or target.
        ...
        // basic buttons
        JButton resetButton, mazeButton, clearButton, realTimeButton, stepButton, animationButton,saveButton, loadButton;
        
        // buttons for selecting the algorithm
        JRadioButton dfs, bfs, aStar, greedy, dijkstra ,bidirect;
        ...
        public MazePanel(int width, int height) {
            ...
            loadButton.addActionListener(new ActionHandler());
            ...
            bidirect = new JRadioButton("Bi-Directional");
            bidirect.setToolTipText("Bi-Directional Search algorithm");
            algoGroup.add(bidirect);
            bidirect.addActionListener(new ActionHandler());
            ...
            saveButton.setBounds(520, 245, 170, 25);
            loadButton.setBounds(520, 275, 170, 25);
            velocity.setBounds(520, 305, 170, 10);
            slider.setBounds(520, 315, 170, 25);
            dfs.setBounds(530, 360, 70, 25);
            bfs.setBounds(600, 360, 70, 25);
            aStar.setBounds(530, 385, 70, 25);
            greedy.setBounds(600, 385, 85, 25);
            dijkstra.setBounds(530, 410, 85, 25);
            bidirect.setBounds(600, 410, 85, 25);
            algoPanel.setLocation(520,340);
            algoPanel.setSize(170, 100);
            diagonal.setBounds(520, 435, 170, 25);
            drawArrows.setBounds(520, 455, 170, 25);
            robot.setBounds(520, 500, 80, 25);
            target.setBounds(605, 500, 80, 25);
            frontier.setBounds(520, 520, 80, 25);
            closed.setBounds(605, 520, 80, 25);
            aboutButton.setBounds(520, 545, 170, 25);
    ...
    static protected JSpinner addLabeledSpinner(Container c,
        ...
        /**
         * Function executed if the user presses the button "Save"
         */
        private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {
        	try {
        		FileWriter fileWriter = new FileWriter("C:\\Users\\rickc\\Downloads\\maze.txt");
        ...
        } // end saveButtonActionPerformed()
        
        
        private void loadButtonActionPerformed(java.awt.event.ActionEvent evt) {
        	try {
        		FileReader fileReader= new FileReader("C:\\Users\\rickc\\Downloads\\maze.txt");
        		int i;
        		char ch=0;
        		
        		int r = 0;
        		int c = 0;
        		while(r < rows && (ch = (char)fileReader.read())!=-1)
        		{
